...
# Introduction to Formal Mathematics with Lean 4 {.unnumbered}
...
- functions, inductive types and quotient types^[Though seemingly [redundant](https://www.ma.imperial.ac.uk/~buzzard/xena/formalising-mathematics-2024/Part_B/threekindsoftypes.html), there are reasons for making quotient types as a fundamental constructing method. [funext](https://lean-lang.org/doc/reference/latest/The-Type-System/Quotients/#quotient-funext) [thesis](https://ncatlab.org/nlab/files/Li-QuotientTypes.pdf)] are the basic methods to construct new types.
...
- Natural language to formal language
  ...
  - bolt-action (search for existing theorems)
    ...
    - [LeanSearch](https://leansearch.net/), [LeanExplore](https://www.leanexplore.com/), ...
...
- a deep discussion into dependent type theory or Lean as a programming language itself
  ...
  - Read [TPiL](https://lean-lang.org/theorem_proving_in_lean4/) for a Lean 4 tutorial that emphasizes on the dependent type theory.
  - Read [FPiL](https://lean-lang.org/functional_programming_in_lean/) for a Lean 4 tutorial that focuses more on functional programming (monads, etc.)
  - Refer to [Lean Language Manual](https://leanprover.github.io/lean4/doc/index.html) for precise specifications.
...
- [online documentation](https://sun123zxy.github.io/lean4-formal-math-intro/)
