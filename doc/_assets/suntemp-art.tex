\RequirePackage{xstring} % For string tests
\RequirePackage{etoolbox} % For hacks
...
\usepackage{fontspec} % seemingly improves font handling, so that \mathbf works with correct bold fonts
