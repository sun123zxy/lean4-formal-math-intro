...
author: 钟星宇 \quad 北京理工大学 \quad sun123zxy@qq.com
date: 2025/09/17
lang: zh
...
本课程原则上不要求任何编程或数学背景，但建议具备至少一侧的常识。我们建议有意动手实操的同学提前配置网络、Git、VSCode 等相关环境。

:::{layout="[4,6]"}

![课程群](wechat.png){#fig-wechat height=180px}
